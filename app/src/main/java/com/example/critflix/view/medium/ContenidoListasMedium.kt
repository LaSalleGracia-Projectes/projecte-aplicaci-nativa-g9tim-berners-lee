    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                actions = {
                    IconButton(onClick = {
                        navController.navigate("${Routes.BusquedaMedium.route}/$id")
                    }) {
                        Icon(
...
fun ContentListItem(
    ...
    Card(
        modifier = Modifier
            ...
            .clickable { 
                when (content.tipo) {
                    "pelicula" -> navController.navigate(Routes.InfoPelisMedium.createRoute(content.tmdb_id))
                    "serie" -> navController.navigate(Routes.InfoSeriesMedium.createRoute(content.tmdb_id))
                }
            },
