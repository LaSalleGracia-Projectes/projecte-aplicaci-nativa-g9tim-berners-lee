...
@Composable
fun InicioSesionExpanded(navController: NavHostController) {
        ...
        when (loginState) {
            is LoginState.Success -> {
                ...
                navController.navigate(Routes.HomeExpanded.route) {
                    popUpTo(Routes.InicioSesionExpanded.route) { inclusive = true }
                }
            }
            is LoginState.Error -> {
    ...
    Column(
        ...
        Row(
            ...
            Text(
                ...
                modifier = Modifier.clickable { navController.navigate(Routes.RegistroExpanded.route) }
            )
        }
    }
