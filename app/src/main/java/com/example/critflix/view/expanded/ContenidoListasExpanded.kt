    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                actions = {
                    IconButton(onClick = {
                        navController.navigate("${Routes.BusquedaExpanded.route}/$id")
                    }) {
                        Icon(
...
fun ContentListItem(
    ...
    Card(
        modifier = Modifier
            ...
            .clickable {
                when (content.tipo) {
                    "pelicula" -> navController.navigate(Routes.InfoPelisExpanded.createRoute(content.tmdb_id))
                    "serie" -> navController.navigate(Routes.InfoSeriesExpanded.createRoute(content.tmdb_id))
                }
            },
